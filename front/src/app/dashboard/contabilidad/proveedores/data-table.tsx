...
// La interfaz de props ahora es más simple
...
export function DataTable<TData, TValue>({
  ...
  const handleSyncProveedores = async () => {
    ...
    try {
      ...
      // Aquí podrías llamar a una función para recargar los datos si fuera necesario
    } catch (error) {
  ...
  const table = useReactTable({
    ...
    // La propiedad 'meta' ya no es necesaria para este flujo
  });
