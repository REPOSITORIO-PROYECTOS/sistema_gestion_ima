"""Agregar las nuevas columnas a la tabla articulos

Revision ID: 47807780b955
Revises: 1955211de63c
Create Date: 2025-07-21 00:18:54.929802
...
revision: str = '47807780b955'
down_revision: Union[str, Sequence[str], None] = '1955211de63c'
...
def upgrade() -> None:
    ...
    op.create_table('descuento_proveedor',
...
def downgrade() -> None:
    ...
    op.drop_table('descuento_proveedor')
    # ### end Alembic commands ###
