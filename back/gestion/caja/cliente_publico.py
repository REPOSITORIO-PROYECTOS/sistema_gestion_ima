...
def obtener_cliente_por_id(db: Session, id_empresa: int, id_cliente: str = None) -> Optional[Dict]:
    """
    Devuelve los datos completos del cliente buscado por ID.
    Si no se encuentra o no se proporciona un ID, devuelve None.
    """
    ...
    # Si el bucle termina y no encontró nada, devuelve None
    return None